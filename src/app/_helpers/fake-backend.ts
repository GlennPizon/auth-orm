    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        function register() {
            ...
            if (accounts.find(x => x.email === account.email)) {
                ...
                setTimeout(() => {
                    alertService.info(`'${account.email}' email is already registered,
                        <br><br>
                        If you don't know your password please visit the <a href="${location.origin}/account/forgot-password">forgot password</a> page.
                        <br>
            ...
            setTimeout(() => {
                ...
                alertService.info(`<h4>Verify Email</h4>
        ...
        function currentAccount() {
            ...
            const tokenExpired = new Date() > new Date(jwtToken.exp * 1000);
